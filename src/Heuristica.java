...
public class Heuristica {
    ...
    public Nodo DondeEsMasBaratoSubir(){
        ...
        int heuristica1 = heuristica(inicial, Destino1) + manhathan(inicial, Destino1);
        int heuristica2 = heuristica(Futuro, Destino2) + manhathan(Futuro, Destino2);
    ...
    public int manhathan(Nodo origen, Nodo destino){
        int yDes = destino.getY();
        int xDes = destino.getX();
        int yOrg = origen.getY();
        int xOrg = origen.getX();

        int distancia = (yDes - yOrg) + (xDes-xOrg);
        return distancia;
    }
